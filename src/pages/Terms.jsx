...
const Terms = () => {
  return (
    <div className="min-h-[80vh] px-4 sm:px-6 md:px-10 py-12 max-w-4xl mx-auto">
      ...
      <div className="mb-8">
        <h2 className="text-3xl font-bold text-[#DD6B20] mb-4">Terms & Conditions</h2>
        <div className="w-16 h-1 bg-[#DD6B20] rounded-full"></div>
      </div>

      <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-6 mb-8">
        <p className="text-gray-700 dark:text-gray-300 mb-4 leading-relaxed">
          Welcome to <span className="font-semibold text-[#DD6B20]">SwiftCarz</span>! By accessing and using our platform, you agree to abide by the terms and conditions outlined below. Please read them carefully before using our services.
        </p>
      </div>

      <div className="space-y-8">
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-6 hover:shadow-md transition-shadow duration-200">
          <h3 className="text-xl font-semibold text-[#DD6B20] mb-3 flex items-center">
            <span className="mr-2">1.</span> User Accounts
          </h3>
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-6 hover:shadow-md transition-shadow duration-200">
          <h3 className="text-xl font-semibold text-[#DD6B20] mb-3 flex items-center">
            <span className="mr-2">2.</span> Car Booking & Cancellations
          </h3>
          <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
            Users can browse, book, or cancel car reservations directly through the platform. Cancellations must be made before the booking start time. SwiftCarz reserves the right to deny future bookings for repeated misuse.
          </p>
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-6 hover:shadow-md transition-shadow duration-200">
          <h3 className="text-xl font-semibold text-[#DD6B20] mb-3 flex items-center">
            <span className="mr-2">3.</span> Use of Vehicles
          </h3>
          <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
            Users must not use vehicles for illegal purposes. Misuse or third-party sharing of booked vehicles is strictly prohibited. SwiftCarz is not liable for any issues arising from vehicle condition, pickup, or handover.
          </p>
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-6 hover:shadow-md transition-shadow duration-200">
          <h3 className="text-xl font-semibold text-[#DD6B20] mb-3 flex items-center">
            <span className="mr-2">4.</span> Privacy
          </h3>
          <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
            We collect limited user data (name, email, photo) to offer personalized experiences. This data is stored securely and never shared without consent. Please refer to our full Privacy Policy for details.
          </p>
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-6 hover:shadow-md transition-shadow duration-200">
          <h3 className="text-xl font-semibold text-[#DD6B20] mb-3 flex items-center">
            <span className="mr-2">5.</span> Modifications
          </h3>
          <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
            SwiftCarz reserves the right to update or modify these terms at any time. Continued use of the platform indicates your acceptance of the revised terms.
          </p>
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-6 hover:shadow-md transition-shadow duration-200">
          <h3 className="text-xl font-semibold text-[#DD6B20] mb-3 flex items-center">
            <span className="mr-2">6.</span> Contact
          </h3>
          <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
            If you have any questions about these Terms & Conditions, please contact us at: <span className="font-medium text-[#DD6B20]">support@swiftcarz.com</span>
          </p>
        </div>
      </div>
    </div>
