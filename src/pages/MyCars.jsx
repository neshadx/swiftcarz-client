...
const UpdateCarModal = ({ car, onClose, onUpdate }) => {
  ...
  const handleSubmit = () => {
    ...
    // Send updated car object to parent component
    onUpdate(updatedCar);
    onClose();
  };
  ...
  return (
    <div className="fixed inset-0 z-50 bg-black bg-opacity-50 flex items-center justify-center px-4">
      <div className="bg-white dark:bg-gray-900 p-6 rounded-lg shadow-lg w-full max-w-md">
        <h2 className="text-xl font-bold text-[#DD6B20] mb-4 text-center">Update Car Info</h2>
        ...
        <div className="space-y-4">
          ...
          <div>
            <label className="block text-sm font-medium mb-1 text-gray-700 dark:text-gray-300">Daily Price ($)</label>
            <input
              type="number"
              value={dailyPrice}
          ...
          <div>
            <label className="block text-sm font-medium mb-1 text-gray-700 dark:text-gray-300">Availability</label>
            <select
              value={availability}
        ...
        <div className="flex justify-end gap-4 mt-6">
          ...
          <button
            ...
            className="px-4 py-2 bg-[#DD6B20] hover:bg-orange-600 text-white rounded"
          >
            Save Changes
          </button>
        </div>
